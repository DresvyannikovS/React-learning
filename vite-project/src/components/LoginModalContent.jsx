...
export const LoginModalContent = ({ toRegistration }) => {
  ...
  return (
    <div className="modal-content-slot blur__form">
        ...
        <div className="blur__content blur__auth">
          ...
          <div className="blur__input-container blur__input-container-gap">
            <div onClick={handleShowPassword} className="visiblePassword">
              {isOpen ? <HidePasswordIcon /> : <ShowPasswordIcon />}
            </div>
            <input
              onChange={handleInputChange}
              name="password"
      ...
      <h2 className="blur__text blur__text-reg">Еще не зарегистрированы?</h2>

      <button
        onClick={toRegistration}
        className="blur__button blur__button-reg red-button"
      >
        Зарегистрироваться
      </button>
    </div>
